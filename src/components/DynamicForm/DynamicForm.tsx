...
export default function DynamicForm({
    ...
    const formSchema = useMemo(() => {
        ...
        schema.forEach(field => {
            ...
            if (field.constraint === "emoji") validator = validator.regex(emojiRegex, "Only emojis allowed");
            if (field.constraint === "lettersOnly") validator = validator.regex(lettersRegex, "Only letters allowed");
            if (field.constraint === "numericOnly") validator = validator.regex(numericRegex, "Only numbers allowed");
        ...
        if (["text", "number"].includes(field.type)) {
            return (
                <Input
                    ...
                    value={v || ""}
                    onChange={(e) => form.setValue(field.name, applyConstraint(e.target.value, field.constraint))}
                />
            );
        }
