        ...
        return (
            <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
                <div className="flex gap-1">
                    <Button variant="outline" className="px-3 py-1" onClick={() => onNavigate(Navigate.PREVIOUS)}>Prev</Button>
                    <Button variant="outline" className="px-3 py-1" onClick={() => onNavigate(Navigate.TODAY)}>Today</Button>
                    <Button variant="outline" className="px-3 py-1" onClick={() => onNavigate(Navigate.NEXT)}>Next</Button>
                </div>
